...
class Config:
    ...
    JOBS = {
        ...
        "walker_walk_noss_imagenetPretrain_video4_lr1e-4_100k_seed2" : "python3 src/train.py \
                --domain_name walker \
                --task_name walk \
                --action_repeat 4 \
                --mode video4 \
                ...
                --train_steps 100000 \
                --work_dir logs/walker_walk/no_ss/imagenetPretrain_video4_lr1e-4_100k_seed2 \
                --save_model \
                --encoder_checkpoint pretraining/checkpoints/imagenet_supervised_002/checkpoint.pth.tar",

        "walker_walk_noss_noPretrain_video4_lr1e-4_100k_seed2" : "python3 src/train.py \
                --domain_name walker \
                --task_name walk \
                --action_repeat 4 \
                --mode video4 \
                ...
                --replay_buffer_size 100000 \
                --train_steps 100000 \
                --work_dir logs/walker_walk/no_ss/noPretrain_video4_lr1e-4_100k_seed2 \
                --save_model",
    }
