...
from models.PixelEncoderFullGroupConv import ClassifierFullGroupConv
from models.PixelEncoderFullGroupConvBigger import ClassifierFullGroupConvBigger
...
classes_chosen = imagenet_r_wnids[::2] # Choose classes for our dataset
...
parser.add_argument('-a', '--arch', default='pixelencoder', choices=[
    'PixelEncoder', 
    'PixelEncoderFullGroupConv', 
    'PixelEncoderFullGroupConvBigger'
])
...
def main_worker(args):
    ...
    elif args.arch == 'PixelEncoderFullGroupConv':
        model = ClassifierFullGroupConv(num_classes=len(classes_chosen)).cuda()
    elif args.arch == 'PixelEncoderFullGroupConvBigger':
        model = ClassifierFullGroupConvBigger(num_classes=len(classes_chosen)).cuda()
    else:
